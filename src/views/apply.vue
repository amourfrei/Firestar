            ...
            <a-col :span="16">
              <div class="title-l">
                ...
                <span class="title-img-s">
                  <img src="../assets/03-gxd.jpg" class="title-img" alt>
                </span>
              </div>
              <div class="title-content">
                <img src="../assets/04-gxd.jpg" class="t-content-img" alt>
              </div>
              <div class="title-form">
                <a-form>
                  <a-form-item
                    ...
                    help
                  >
                    <a-input id="error" placeholder addonAfter="万元"/>
                  </a-form-item>
                  <a-form-item
                    :label-col="labelCol"
                    :wrapper-col="wrapperCol"
                    ...
                    help
                  >
                    <a-input id="error" placeholder addonAfter="个月"/>
                  </a-form-item>
                  <a-button class="apply-btn" size="large">立即申请</a-button>
          ...
          <a-col>
            <a-card :loading="loading" :bordered="false" :body-style="{padding: '0'}">
              <div class="salesCard">
                ...
                >
                  <a-tab-pane loading="true" tab="费用说明" key="1">
                    <a-row>
                      <a-col>
                        <p class="key-1-msg">
                  ...
                  <a-tab-pane tab="还款说明" key="2">
                    <a-row>
                      <a-col>
                        <div class="ex-item" v-for="(item,index) in exList" :key="index">
                  ...
                  <a-tab-pane tab="流程办理" key="3">
                    <a-row>
                      <a-col :span="18" :offset="3">
                        <a-steps :current="2" class="process-pad">
                          <a-step>
...
const sourceData = [{ item: '贷款10万／12个月', count: 100 }]
